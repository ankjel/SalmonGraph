...
awk 'OFS=FS="\t"''{print $1, "1", $2, "100.0", "100.0"}' maxdims.tsv > $outhack/shorts.laser.simple.bed
...
-s $outhack -b $outhack/shorts.laser.simple.bed -g $ref -o $outshorts --threads $SLURM_CPUS_ON_NODE  --coverage 2 --fastq

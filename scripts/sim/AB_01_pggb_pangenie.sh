...
fasta=/mnt/SCRATCH/ankjelst/data/pangenie/inputPangenie.fasta

#wfmash
param_s=100000
param_p=95
param_n=4  #Ideally, you should set this to equal the number of haplotypes in the pangenome.
param_K=19
...
SCRATCHout=/mnt/SCRATCH/ankjelst/data/pangenie/$out
